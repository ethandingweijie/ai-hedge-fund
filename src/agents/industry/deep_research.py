...
def _extract_saas_metrics(
    ...
    _system_prompt = (
        ...
        "  ltv_cac_ratio: float (1-15) — COHORT-MATCHED: CAC = period S&M / NEW customers added (NOT total customers); LTV = (cohort ACV × gross margin) / annual churn. Elite SaaS 7-15x. If your derivation gives >15, you almost certainly used total-customers / blended-ACV — recompute with the new-customer cohort and the cohort-specific ACV before reporting.\n"

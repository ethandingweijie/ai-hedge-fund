...
TICKER_SECTOR_LOOKUP: dict[str, _TL] = {
    ...
    "O":     ("RealEstate", "",                   "R.E.I.T.",                         "Realty Income REIT — single-tenant net lease"),
    "AMT":   ("RealEstate", "",                   "R.E.I.T.",                         "American Tower REIT — telecoms towers"),
    "DLR":   ("RealEstate", "",                   "R.E.I.T.",                         "Digital Realty REIT — data center / interconnection"),
    "EQIX":  ("RealEstate", "",                   "R.E.I.T.",                         "Equinix REIT — data center / interconnection"),

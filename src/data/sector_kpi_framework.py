...
SECTOR_KPI_FRAMEWORK: dict[str, dict] = {
    ...
    "Growth SaaS": {
        ...
        "kpis": [
            ...
            },
            {
                ...
                "compute_hint":    "LTV / CAC ratio (target >3x; cybersecurity / mission-critical SaaS can hit 50-100x with >97% gross retention)",
                "clamp":           (1, 100),
                "extractor_only":  True,
            },
            {
    ...
    "Mature SaaS": {
        ...
        "kpis": [
            ...
            {"key": "ltv_cac_ratio",        "mandatory": False, "search_phrases": ["LTV:CAC"],              "clamp": (1, 100),      "extractor_only": True},

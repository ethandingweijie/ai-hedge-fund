    ...
    "Growth SaaS": {
        ...
        "kpis": [
            ...
            },
            {
                ...
                "compute_hint":    "LTV/CAC — COHORT-MATCHED. CAC = period S&M / NEW customers added (NOT total customers). LTV = (cohort ACV × gross margin) / annual churn. Target >3x; elite SaaS 7-15x. Values >15 usually indicate the blended-ACV / total-customers calculation error — flag for re-derivation.",
                "clamp":           (1, 15),
                "extractor_only":  True,
            },
            {

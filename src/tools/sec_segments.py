...
# Market-agnostic segment rules live in one place so a new market
# implements only a parser -- see src/tools/segment_normalize.py.
from src.tools.segment_normalize import (  # noqa: F401
    normalize_key,
    _GEO_AXIS_RE, _GEO_NAME_RE, _BUSINESS_LINE_RE,
    _is_geographic, _drop_hierarchy_parents, _filter_segments,
)

  ...
  return (
    <>
      ...
      <div
        ...
        style={isMobile ? { paddingTop: 'calc(env(safe-area-inset-top, 0px) + 6px)' } : undefined}
      >
        <div
          className={cn(
        ...
        >
          <div className="min-w-0">
            ...
            <h1 className="font-bold tracking-tight leading-none flex items-center gap-2.5 text-[26px] md:text-[30px]">
              {Icon && (
                <Icon
                  strokeWidth={2.5}
                  className={cn(
